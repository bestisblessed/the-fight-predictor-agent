...
def create_doc(file_path):
    ...
    drive_service = build('drive', 'v3', credentials=creds)  # Add Drive service
    ...
    try:
        ...
        folder_id = "1JWgU-jjaFpnEu1Aw_8kpoFE8dg8m_lpM"  # Your folder ID from the URL
        ...
        print(f"Google Doc created successfully with ID: {doc_id} in the specified folder")
        return doc_id
